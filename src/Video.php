	...
	private function getRuTubeInfo()
	{
		...
		if(count($match)){
			...
			if($json['track_id']){
				...
				//$json['track_id']
				$this->videoInfo['video'] = '<div class="embed"><div class="embed-responsive embed-responsive-16by9"><iframe src="https://rutube.ru/play/embed/' . $this->videoInfo['id'] . '" frameborder="0" allow="clipboard-write" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
